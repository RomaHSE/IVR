...
interface UserDao {
    ...
    fun deleteByUid(userId: Int)

    @Query("UPDATE Users SET u_name=:userName, u_login=:userLogin, u_password=:userPassword WHERE uid=:userId")
    fun updateUserData(userName: String, userLogin: String, userPassword: String, userId: Int)
